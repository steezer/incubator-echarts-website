window.__EC_DOC_option_series_line = {
  "id": {
  ...
  "symbolSize": {
    "desc": "<p>line point symbol size. It can be set to single numbers like <code class=\"codespan\">10</code>, or use an array to represent width and height. For example, <code class=\"codespan\">[20, 10]</code> means symbol width is <code class=\"codespan\">20</code>, and height is<code class=\"codespan\">10</code>.</p>\n<p>If size of symbols needs to be different, you can set with callback function in the following format:</p>\n<pre><code class=\"lang-js\">(value: Array|number, params: Object) =&gt; number|Array\n</code></pre>\n<p>The first parameter <code class=\"codespan\">value</code> is the value in <a href=\"#series-line.data\">data</a>, and the second parameter <code class=\"codespan\">params</code> is the rest parameters of data item.</p>\n",
    "uiControl": {
      "type": "number",
      "min": "0"
    }
  ...
  "showSymbol": {
    "desc": "<p>Whether to show symbol. It would be shown during tooltip hover.</p>\n",
    "uiControl": {
      "type": "boolean",
      "default": "true"
    }
  ...
  "stack": {
    "desc": "<p>If stack the value. On the same category axis, the series with the same <code class=\"codespan\">stack</code> name would be put on top of each other.</p>\n<p>The effect of the below example could be seen through stack switching of <a href=\"#toolbox\">toolbox</a> on the top right corner:</p>\n<iframe  data-src=\"https://www.echartsjs.com/examples/zh/view.html?c=doc-example/line-stack-tiled&edit=1&reset=1\" width=\"600\" height=\"400\"><iframe />\n\n\n\n"
  },
  "cursor": {
  ...
  "connectNulls": {
    "desc": "<p>Whether to connect the line across null points.</p>\n",
    "uiControl": {
      "type": "boolean"
    }
  },
  ...
  "step": {
    "desc": "<p>Whether to show as a step line. It can be <code class=\"codespan\">true</code>, <code class=\"codespan\">false</code>. Or <code class=\"codespan\">&#39;start&#39;</code>, <code class=\"codespan\">&#39;middle&#39;</code>, <code class=\"codespan\">&#39;end&#39;</code>. Which will configure the turn point of step line.</p>\n<p>See the example using different <code class=\"codespan\">step</code> options:</p>\n<iframe  data-src=\"https://www.echartsjs.com/examples/zh/view.html?c=line-step&edit=1&reset=1\" width=\"600\" height=\"400\"><iframe />\n\n\n\n",
    "uiControl": {
      "type": "enum",
  ...
  "itemStyle": {
    "desc": "<p>The style of the symbol point of broken line.</p>\n"
  },
  "itemStyle.color": {
  ...
  "emphasis": {
    "desc": "<p>Highlight style of the graphic.</p>\n"
  },
  "emphasis.label.show": {
    "desc": "<p>Whether to show label.</p>\n",
    "uiControl": {
  ...
  "data.label": {
    "desc": "<p>The style of the text of single data point.</p>\n"
  },
  "data.label.show": {
    "desc": "<p>Whether to show label.</p>\n",
    "uiControl": {
  ...
  "data.itemStyle": {
    "desc": "<p>The style of the symbol of single data point.</p>\n"
  },
  ...
  "markPoint.data.valueIndex": {
    "desc": "<p>Available when using <a href=\"#series-line.markPoint.data.type\">type</a> it is used to assign maximum value and minimum value in dimensions, it could be <code class=\"codespan\">0</code> (xAxis, radiusAxis), <code class=\"codespan\">1</code> (yAxis, angleAxis), and use the first value axis dimension by default.</p>\n",
    "uiControl": {
      "type": "number",
      "min": "0",
      "max": "1",
  ...
  "markLine.symbol": {
    "desc": "<p>Symbol type at the two ends of the mark line. It can be an array for two ends, or assigned seperately. See <a href=\"#series-line.markLine.data.0.symbol\">data.symbol</a> for more format information.</p>\n"
  },
  "markLine.symbolSize": {
  ...
  "zlevel": {
    "desc": "<p><code class=\"codespan\">zlevel</code> value of all graphical elements in broken line graph.</p>\n<p><code class=\"codespan\">zlevel</code> is used to make layers with Canvas. Graphical elements with different <code class=\"codespan\">zlevel</code> values will be placed in different Canvases, which is a common optimization technique. We can put those frequently changed elements (like those with animations) to a separate <code class=\"codespan\">zlevel</code>. Notice that too many Canvases will increase memory cost, and should be used carefully on mobile phones to avoid crash.</p>\n<p>Canvases with bigger <code class=\"codespan\">zlevel</code> will be placed on Canvases with smaller <code class=\"codespan\">zlevel</code>.</p>\n"
  },
  "z": {
    "desc": "<p><code class=\"codespan\">z</code> value of all graphical elements in broken line graph, which controls order of drawing graphical components. Components with smaller <code class=\"codespan\">z</code> values may be overwritten by those with larger <code class=\"codespan\">z</code> values.</p>\n<p><code class=\"codespan\">z</code> has a lower priority to <code class=\"codespan\">zlevel</code>, and will not create new Canvas.</p>\n"
  },
  "silent": {
    "desc": "<p>Whether to ignore mouse events. Default value is false, for triggering and responding to mouse events.</p>\n",
    "uiControl": {
