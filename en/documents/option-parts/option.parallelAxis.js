window.__EC_DOC_option_parallelAxis = {
  ...
  "realtime": {
    "desc": "<p>Whether to refresh view when brush-selecting axis. If is set to be <code class=\"codespan\">false</code>, view is updated after brush-selecting action ends.</p>\n<p>When data amount is large, it is suggested to set to be <code class=\"codespan\">false</code> to avoid efficiency problems.</p>\n",
    "uiControl": {
      "type": "boolean",
      "default": "true"
    }
  ...
  "areaSelectStyle.width": {
    "desc": "<p>Width of selecting box.</p>\n",
    "uiControl": {
      "type": "number",
      "min": "0",
      "default": "20",
  ...
  "areaSelectStyle.borderWidth": {
    "desc": "<p>Border width of the select box.</p>\n",
    "uiControl": {
      "type": "number",
      "min": "0",
      "default": "1",
  ...
  "areaSelectStyle.borderColor": {
    "desc": "<p>Border color of the select box.</p>\n",
    "uiControl": {
      "type": "color",
  ...
  "areaSelectStyle.color": {
    "desc": "<p>Border fill color of the select box.</p>\n",
    "uiControl": {
      "type": "color",
      "default": "rgba(160,197,232)"
    }
  ...
  "areaSelectStyle.opacity": {
    "desc": "<p>Opacity of the select box.</p>\n",
    "uiControl": {
      "type": "number",
      "min": "0",
      "max": "1",
