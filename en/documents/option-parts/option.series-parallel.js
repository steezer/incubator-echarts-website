window.__EC_DOC_option_series_parallel = {
  ...
  "inactiveOpacity": {
    "desc": "<p>When perform brush selection, the unselected lines will be set as this transparency rate (which could darken those lines).</p>\n",
    "uiControl": {
      "type": "number",
      "min": "0",
      "max": "1",
  ...
  "activeOpacity": {
    "desc": "<p>When perform brush selection, the selected lines will be set as this transparency rate (which could highlight those lines).</p>\n",
    "uiControl": {
      "type": "number",
      "min": "0",
      "max": "1",
  ...
  "realtime": {
    "desc": "<p>Whether to update view in realtime.</p>\n",
    "uiControl": {
      "type": "boolean",
      "default": "true"
    }
  ...
  "smooth": {
    "desc": "<p>Whether to smooth the line. It defaults to be <code class=\"codespan\">false</code> and can be set as <code class=\"codespan\">true</code> or the values from 0 to 1 which indicating the smoothness.</p>\n",
    "uiControl": {
      "type": "boolean"
    }
  },
