window.__EC_DOC_option_series_funnel = {
  ...
  "label": {
    "desc": "<p>漏斗图图形上的文本标签，可用于说明图形的一些数据信息，比如值，名称等，<code class=\"codespan\">label</code>选项在 ECharts 2.x 中放置于<code class=\"codespan\">itemStyle</code>下，在 ECharts 3 中为了让整个配置项结构更扁平合理，<code class=\"codespan\">label</code> 被拿出来跟 <code class=\"codespan\">itemStyle</code> 平级，并且跟 <code class=\"codespan\">itemStyle</code> 一样拥有 <code class=\"codespan\">emphasis</code> 状态。</p>\n"
  },
  "label.position": {
  ...
  "labelLine": {
    "desc": "<p>标签的视觉引导线样式，在 <a href=\"#series-funnel.label.position\">label 位置</a> 设置为<code class=\"codespan\">&#39;left&#39;</code>或者<code class=\"codespan\">&#39;right&#39;</code>的时候会显示视觉引导线。</p>\n"
  },
  "labelLine.show": {
    "desc": "<p>是否显示视觉引导线。</p>\n"
  },
  ...
  "markLine.symbol": {
    "desc": "<p>标线两端的标记类型，可以是一个数组分别指定两端，也可以是单个统一指定，具体格式见 <a href=\"#series-funnel.markLine.data.0.symbol\">data.symbol</a>。</p>\n"
  },
  "markLine.symbolSize": {
