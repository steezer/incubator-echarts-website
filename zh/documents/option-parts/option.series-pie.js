window.__EC_DOC_option_series_pie = {
  ...
  "avoidLabelOverlap": {
    "desc": "\n\n<p>是否启用防止标签重叠策略，默认开启，在标签拥挤重叠的情况下会挪动各个标签的位置，防止标签间的重叠。</p>\n<p>如果不需要开启该策略，例如<a href=\"https://www.echartsjs.com/examples/zh/editor.html?c=pie-doughnut\" target=\"_blank\">圆环图</a>这个例子中需要强制所有标签放在中心位置，可以将该值设为 <code class=\"codespan\">false</code>。</p>\n",
    "uiControl": {
      "type": "boolean",
      "default": "true"
    }
  ...
  "labelLine": {
    "desc": "<p>标签的视觉引导线样式，在 <a href=\"#series-pie.label.position\">label 位置</a> 设置为<code class=\"codespan\">&#39;outside&#39;</code>的时候会显示视觉引导线。</p>\n"
  },
  "labelLine.show": {
    "desc": "\n\n<p>是否显示视觉引导线。</p>\n",
    "uiControl": {
  ...
  "labelLine.length2": {
    "desc": "<p><ExampleUIControlNumber default=\"15\" min=\"0\" step=\"1\" />\n视觉引导项第二段的长度。</p>\n"
  },
  "labelLine.smooth": {
  ...
  "markLine.symbol": {
    "desc": "<p>标线两端的标记类型，可以是一个数组分别指定两端，也可以是单个统一指定，具体格式见 <a href=\"#series-pie.markLine.data.0.symbol\">data.symbol</a>。</p>\n"
  },
  "markLine.symbolSize": {
