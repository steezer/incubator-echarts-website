window.__EC_DOC_option_series_sankey = {
  ...
  "levels.lineStyle": {
    "desc": "<p>桑基图指定层出边的样式。其中 <a href=\"#series-sankey.lineStyle.color\">lineStyle.color</a> 支持设置为<code class=\"codespan\">&#39;source&#39;</code>或者<code class=\"codespan\">&#39;target&#39;</code>特殊值，此时出边会自动取源节点或目标节点的颜色作为自己的颜色。</p>\n"
  },
