window.__EC_DOC_option_series_graph = {
  ...
  "layout": {
    "desc": "\n\n<p>图的布局。</p>\n<p><strong>可选：</strong></p>\n<ul>\n<li><p><code class=\"codespan\">&#39;none&#39;</code> 不采用任何布局，使用<a href=\"#series-graph.data\">节点</a>中提供的 <a href=\"#series-graph.data.x\">x</a>， <a href=\"#series-graph.data.y\">y</a> 作为节点的位置。</p>\n</li>\n<li><p><code class=\"codespan\">&#39;circular&#39;</code> 采用环形布局，见示例 <a href=\"/examples/zh/editor.html?c=graph-circular-layout\" target=\"_blank\">Les Miserables</a>，布局相关的配置项见 <a href=\"#series-graph.circular\">graph.circular</a></p>\n</li>\n<li><p><code class=\"codespan\">&#39;force&#39;</code> 采用力引导布局，见示例 <a href=\"/examples/zh/editor.html?c=graph-force\" target=\"_blank\">Force</a>，布局相关的配置项见 <a href=\"#series-graph.force\">graph.force</a></p>\n</li>\n</ul>\n",
    "uiControl": {
      "type": "enum",
