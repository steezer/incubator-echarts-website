window.__EC_DOC_option_series_graph = {
  ...
  "hoverAnimation": {
    "desc": "<p>是否开启鼠标 hover 节点的提示动画效果。</p>\n"
  },
  "center": {
  ...
  "layout": {
    "desc": "\n\n<p>图的布局。</p>\n<p><strong>可选：</strong></p>\n<ul>\n<li><p><code class=\"codespan\">&#39;none&#39;</code> 不采用任何布局，使用<a href=\"#series-graph.data\">节点</a>中提供的 <a href=\"#series-graph.data.x\">x</a>， <a href=\"#series-graph.data.y\">y</a> 作为节点的位置。</p>\n</li>\n<li><p><code class=\"codespan\">&#39;circular&#39;</code> 采用环形布局，见示例 <a href=\"https://www.echartsjs.com/examples/zh/editor.html?c=graph-circular-layout\" target=\"_blank\">Les Miserables</a>，布局相关的配置项见 <a href=\"#series-graph.circular\">graph.circular</a></p>\n</li>\n<li><p><code class=\"codespan\">&#39;force&#39;</code> 采用力引导布局，见示例 <a href=\"https://www.echartsjs.com/examples/zh/editor.html?c=graph-force\" target=\"_blank\">Force</a>，布局相关的配置项见 <a href=\"#series-graph.force\">graph.force</a></p>\n</li>\n</ul>\n",
    "uiControl": {
      "type": "enum",
  ...
  "force.friction": {
    "desc": "\n\n\n\n<blockquote>\n<p>从 <code class=\"codespan\">v4.5.0</code> 开始支持</p>\n</blockquote>\n<p>这个参数能减缓节点的移动速度。取值范围 0 到 1。</p>\n<p>但是仍然是个试验性的参数，参见 <a href=\"https://github.com/apache/incubator-echarts/issues/11024\" target=\"_blank\">#11024</a>。</p>\n",
    "uiControl": {
      "type": "number",
      "min": "0",
      "max": "1",
  ...
  "edgeSymbol": {
    "desc": "<p>边两端的标记类型，可以是一个数组分别指定两端，也可以是单个统一指定。默认不显示标记，常见的可以设置为箭头，如下：</p>\n<pre><code class=\"lang-js\">edgeSymbol: [&#39;circle&#39;, &#39;arrow&#39;]\n</code></pre>\n"
  },
  "edgeSymbolSize": {
  ...
  "lineStyle": {
    "desc": "<p>关系边的公用线条样式。其中 <a href=\"#series-graph.lineStyle.color\">lineStyle.color</a> 支持设置为<code class=\"codespan\">&#39;source&#39;</code>或者<code class=\"codespan\">&#39;target&#39;</code>特殊值，此时边会自动取源节点或目标节点的颜色作为自己的颜色。</p>\n"
  },
  "lineStyle.color": {
    "desc": "\n\n<p>线的颜色。</p>\n<blockquote>\n<p>颜色可以使用 RGB 表示，比如 <code class=\"codespan\">&#39;rgb(128, 128, 128)&#39;</code>，如果想要加上 alpha 通道表示不透明度，可以使用 RGBA，比如 <code class=\"codespan\">&#39;rgba(128, 128, 128, 0.5)&#39;</code>，也可以使用十六进制格式，比如 <code class=\"codespan\">&#39;#ccc&#39;</code>。除了纯色之外颜色也支持渐变色和纹理填充</p>\n<pre><code class=\"lang-js\">// 线性渐变，前四个参数分别是 x0, y0, x2, y2, 范围从 0 - 1，相当于在图形包围盒中的百分比，如果 globalCoord 为 `true`，则该四个值是绝对的像素位置\ncolor: {\n    type: &#39;linear&#39;,\n    x: 0,\n    y: 0,\n    x2: 0,\n    y2: 1,\n    colorStops: [{\n        offset: 0, color: &#39;red&#39; // 0% 处的颜色\n    }, {\n        offset: 1, color: &#39;blue&#39; // 100% 处的颜色\n    }],\n    global: false // 缺省为 false\n}\n// 径向渐变，前三个参数分别是圆心 x, y 和半径，取值同线性渐变\ncolor: {\n    type: &#39;radial&#39;,\n    x: 0.5,\n    y: 0.5,\n    r: 0.5,\n    colorStops: [{\n        offset: 0, color: &#39;red&#39; // 0% 处的颜色\n    }, {\n        offset: 1, color: &#39;blue&#39; // 100% 处的颜色\n    }],\n    global: false // 缺省为 false\n}\n// 纹理填充\ncolor: {\n    image: imageDom, // 支持为 HTMLImageElement, HTMLCanvasElement，不支持路径字符串\n    repeat: &#39;repeat&#39; // 是否平铺，可以是 &#39;repeat-x&#39;, &#39;repeat-y&#39;, &#39;no-repeat&#39;\n}\n</code></pre>\n</blockquote>\n",
    "uiControl": {
  ...
  "categories.name": {
    "desc": "<p>类目名称，用于和 <a href=\"#legend\">legend</a> 对应以及格式化 <a href=\"#tooltip\">tooltip</a> 的内容。</p>\n"
  },
  "categories.symbol": {
    "desc": "\n\n<p>该类目节点标记的图形。</p>\n<p>ECharts 提供的标记类型包括 \n<code class=\"codespan\">&#39;circle&#39;</code>, <code class=\"codespan\">&#39;rect&#39;</code>, <code class=\"codespan\">&#39;roundRect&#39;</code>, <code class=\"codespan\">&#39;triangle&#39;</code>, <code class=\"codespan\">&#39;diamond&#39;</code>, <code class=\"codespan\">&#39;pin&#39;</code>, <code class=\"codespan\">&#39;arrow&#39;</code>, <code class=\"codespan\">&#39;none&#39;</code></p>\n<p>可以通过 <code class=\"codespan\">&#39;image://url&#39;</code> 设置为图片，其中 URL 为图片的链接，或者 <code class=\"codespan\">dataURI</code>。</p>\n<p>URL 为图片链接例如：</p>\n<pre><code>&#39;image://http://xxx.xxx.xxx/a/b.png&#39;\n</code></pre><p>URL 为 <code class=\"codespan\">dataURI</code> 例如：</p>\n<pre><code>&#39;image://data:image/gif;base64,&#39;\n</code></pre><p>可以通过 <code class=\"codespan\">&#39;path://&#39;</code> 将图标设置为任意的矢量路径。这种方式相比于使用图片的方式，不用担心因为缩放而产生锯齿或模糊，而且可以设置为任意颜色。路径图形会自适应调整为合适的大小。路径的格式参见 <a href=\"http://www.w3.org/TR/SVG/paths.html#PathData\" target=\"_blank\">SVG PathData</a>。可以从 Adobe Illustrator 等工具编辑导出。</p>\n<p>例如：</p>\n<pre><code>&#39;path://M30.9,53.2C16.8,53.2,5.3,41.7,5.3,27.6S16.8,2,30.9,2C45,2,56.4,13.5,56.4,27.6S45,53.2,30.9,53.2z M30.9,3.5C17.6,3.5,6.8,14.4,6.8,27.6c0,13.3,10.8,24.1,24.101,24.1C44.2,51.7,55,40.9,55,27.6C54.9,14.4,44.1,3.5,30.9,3.5z M36.9,35.8c0,0.601-0.4,1-0.9,1h-1.3c-0.5,0-0.9-0.399-0.9-1V19.5c0-0.6,0.4-1,0.9-1H36c0.5,0,0.9,0.4,0.9,1V35.8z M27.8,35.8 c0,0.601-0.4,1-0.9,1h-1.3c-0.5,0-0.9-0.399-0.9-1V19.5c0-0.6,0.4-1,0.9-1H27c0.5,0,0.9,0.4,0.9,1L27.8,35.8L27.8,35.8z&#39;\n</code></pre>",
    "uiControl": {
  ...
  "data.x": {
    "desc": "<p>节点的初始 x 值。在不指定的时候需要指明<code class=\"codespan\">layout</code>属性选择布局方式。</p>\n"
  },
  "data.y": {
    "desc": "<p>节点的初始 y 值。在不指定的时候需要指明<code class=\"codespan\">layout</code>属性选择布局方式。</p>\n"
  },
  "data.fixed": {
    "desc": "<p>节点在力引导布局中是否固定。</p>\n"
  },
  "data.value": {
    "desc": "<p>数据项值。</p>\n"
  },
  "data.category": {
    "desc": "<p>数据项所在类目的 index。</p>\n"
  },
  "data.symbol": {
    "desc": "\n\n<p>该类目节点标记的图形。</p>\n<p>ECharts 提供的标记类型包括 \n<code class=\"codespan\">&#39;circle&#39;</code>, <code class=\"codespan\">&#39;rect&#39;</code>, <code class=\"codespan\">&#39;roundRect&#39;</code>, <code class=\"codespan\">&#39;triangle&#39;</code>, <code class=\"codespan\">&#39;diamond&#39;</code>, <code class=\"codespan\">&#39;pin&#39;</code>, <code class=\"codespan\">&#39;arrow&#39;</code>, <code class=\"codespan\">&#39;none&#39;</code></p>\n<p>可以通过 <code class=\"codespan\">&#39;image://url&#39;</code> 设置为图片，其中 URL 为图片的链接，或者 <code class=\"codespan\">dataURI</code>。</p>\n<p>URL 为图片链接例如：</p>\n<pre><code>&#39;image://http://xxx.xxx.xxx/a/b.png&#39;\n</code></pre><p>URL 为 <code class=\"codespan\">dataURI</code> 例如：</p>\n<pre><code>&#39;image://data:image/gif;base64,&#39;\n</code></pre><p>可以通过 <code class=\"codespan\">&#39;path://&#39;</code> 将图标设置为任意的矢量路径。这种方式相比于使用图片的方式，不用担心因为缩放而产生锯齿或模糊，而且可以设置为任意颜色。路径图形会自适应调整为合适的大小。路径的格式参见 <a href=\"http://www.w3.org/TR/SVG/paths.html#PathData\" target=\"_blank\">SVG PathData</a>。可以从 Adobe Illustrator 等工具编辑导出。</p>\n<p>例如：</p>\n<pre><code>&#39;path://M30.9,53.2C16.8,53.2,5.3,41.7,5.3,27.6S16.8,2,30.9,2C45,2,56.4,13.5,56.4,27.6S45,53.2,30.9,53.2z M30.9,3.5C17.6,3.5,6.8,14.4,6.8,27.6c0,13.3,10.8,24.1,24.101,24.1C44.2,51.7,55,40.9,55,27.6C54.9,14.4,44.1,3.5,30.9,3.5z M36.9,35.8c0,0.601-0.4,1-0.9,1h-1.3c-0.5,0-0.9-0.399-0.9-1V19.5c0-0.6,0.4-1,0.9-1H36c0.5,0,0.9,0.4,0.9,1V35.8z M27.8,35.8 c0,0.601-0.4,1-0.9,1h-1.3c-0.5,0-0.9-0.399-0.9-1V19.5c0-0.6,0.4-1,0.9-1H27c0.5,0,0.9,0.4,0.9,1L27.8,35.8L27.8,35.8z&#39;\n</code></pre>",
    "uiControl": {
  ...
  "nodes": {
    "desc": "<p>别名，同 <a href=\"#series-graph.data\">data</a></p>\n"
  },
  "links": {
    "desc": "<p>节点间的关系数据。示例：</p>\n<pre><code class=\"lang-js\">links: [{\n    source: &#39;n1&#39;,\n    target: &#39;n2&#39;\n}, {\n    source: &#39;n2&#39;,\n    target: &#39;n3&#39;\n}]\n</code></pre>\n"
  },
  "links.source": {
    "desc": "<p>边的<a href=\"#series-graph.data.name\">源节点名称</a>的字符串，也支持使用数字表示源节点的索引。</p>\n"
  },
  "links.target": {
    "desc": "<p>边的<a href=\"#series-graph.data.name\">目标节点名称</a>的字符串，也支持使用数字表示源节点的索引。</p>\n"
  },
  "links.value": {
    "desc": "<p>边的数值，可以在力引导布局中用于映射到边的长度。</p>\n"
  },
  "links.lineStyle": {
    "desc": "<p>关系边的线条样式。</p>\n"
  },
  ...
  "links.symbol": {
    "desc": "<p>边两端的标记类型，可以是一个数组分别指定两端，也可以是单个统一指定。</p>\n"
  },
  "links.symbolSize": {
    "desc": "<p>边两端的标记大小，可以是一个数组分别指定两端，也可以是单个统一指定。</p>\n"
  },
  "links.ignoreForceLayout": {
    "desc": "<blockquote>\n<p>从 <code class=\"codespan\">v4.5.0</code> 开始支持</p>\n</blockquote>\n<p>使此边不进行力导图布局的计算。</p>\n"
  },
  "edges": {
    "desc": "<p>别名，同 <a href=\"#series-graph.links\">links</a></p>\n"
  },
  "markPoint": {
    "desc": "<p>图表标注。</p>\n"
  },
  ...
  "markPoint.data.valueIndex": {
    "desc": "\n\n<p>在使用 <a href=\"#series-graph.markPoint.data.type\">type</a> 时有效，用于指定在哪个维度上指定最大值最小值，可以是 <code class=\"codespan\">0</code>（xAxis, radiusAxis），<code class=\"codespan\">1</code>（yAxis, angleAxis），默认使用第一个数值轴所在的维度。</p>\n",
    "uiControl": {
      "type": "number",
      "min": "0",
      "max": "1",
  ...
  "markPoint.data.valueDim": {
    "desc": "<p>在使用 <a href=\"#series-graph.markPoint.data.type\">type</a> 时有效，用于指定在哪个维度上指定最大值最小值。这可以是维度的直接名称，例如折线图时可以是<code class=\"codespan\">x</code>、<code class=\"codespan\">angle</code>等、candlestick 图时可以是<code class=\"codespan\">open</code>、<code class=\"codespan\">close</code>等维度名称。</p>\n"
  },
  ...
  "markLine.symbol": {
    "desc": "<p>标线两端的标记类型，可以是一个数组分别指定两端，也可以是单个统一指定，具体格式见 <a href=\"#series-graph.markLine.data.0.symbol\">data.symbol</a>。</p>\n"
  },
  "markLine.symbolSize": {
  ...
  "markLine.data.0.valueIndex": {
    "desc": "\n\n<p>在使用 <a href=\"#series-graph.markLine.data.type\">type</a> 时有效，用于指定在哪个维度上指定最大值最小值，可以是 <code class=\"codespan\">0</code>（xAxis, radiusAxis），<code class=\"codespan\">1</code>（yAxis, angleAxis），默认使用第一个数值轴所在的维度。</p>\n",
    "uiControl": {
      "type": "number",
      "min": "0",
      "max": "1",
  ...
  "markLine.data.0.valueDim": {
    "desc": "<p>在使用 <a href=\"#series-graph.markLine.data.type\">type</a> 时有效，用于指定在哪个维度上指定最大值最小值。这可以是维度的直接名称，例如折线图时可以是<code class=\"codespan\">x</code>、<code class=\"codespan\">angle</code>等、candlestick 图时可以是<code class=\"codespan\">open</code>、<code class=\"codespan\">close</code>等维度名称。</p>\n"
  },
  ...
  "markArea.data.0.valueIndex": {
    "desc": "\n\n<p>在使用 <a href=\"#series-graph.markArea.data.type\">type</a> 时有效，用于指定在哪个维度上指定最大值最小值，可以是 <code class=\"codespan\">0</code>（xAxis, radiusAxis），<code class=\"codespan\">1</code>（yAxis, angleAxis），默认使用第一个数值轴所在的维度。</p>\n",
    "uiControl": {
      "type": "number",
      "min": "0",
      "max": "1",
  ...
  "markArea.data.0.valueDim": {
    "desc": "<p>在使用 <a href=\"#series-graph.markArea.data.type\">type</a> 时有效，用于指定在哪个维度上指定最大值最小值。这可以是维度的直接名称，例如折线图时可以是<code class=\"codespan\">x</code>、<code class=\"codespan\">angle</code>等、candlestick 图时可以是<code class=\"codespan\">open</code>、<code class=\"codespan\">close</code>等维度名称。</p>\n"
  },
