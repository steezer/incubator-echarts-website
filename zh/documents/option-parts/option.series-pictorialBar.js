window.__EC_DOC_option_series_pictorialBar = {
  ...
  "data.z": {
    "desc": "<p>指定图形元素间的覆盖关系。数值越大，越在层叠的上方。</p>\n"
  },
  "data.hoverAnimation": {
    "desc": "\n\n<p>是否开启 hover 在图形上的提示动画效果。</p>\n<p>此属性可以被设置在系列的 <a href=\"#series-pictorialBar.hoverAnimation\">根部</a>，表示对此系列中所有数据都生效；也可以被设置在 <a href=\"series-pictorialBar.data\" target=\"_blank\">data</a> 中的 <a href=\"#series-pictorialBar.data.hoverAnimation\">每个数据项中</a>，表示只对此数据项生效。</p>\n<p>例如：</p>\n<pre><code class=\"lang-js\">series: [{\n    hoverAnimation: ... // 对 data 中所有数据项生效。\n    data: [23, 56]\n}]\n或者\nseries: [{\n    data: [{\n        value: 23\n        hoverAnimation: ... // 只对此数据项生效\n    }, {\n        value: 56\n        hoverAnimation: ... // 只对此数据项生效\n    }]\n}]\n</code></pre>\n",
    "uiControl": {
  ...
  "markPoint.data.valueIndex": {
    "desc": "\n\n<p>在使用 <a href=\"#series-pictorialBar.markPoint.data.type\">type</a> 时有效，用于指定在哪个维度上指定最大值最小值，可以是 <code class=\"codespan\">0</code>（xAxis, radiusAxis），<code class=\"codespan\">1</code>（yAxis, angleAxis），默认使用第一个数值轴所在的维度。</p>\n",
    "uiControl": {
      "type": "number",
      "min": "0",
      "max": "1",
  ...
  "markPoint.data.valueDim": {
    "desc": "<p>在使用 <a href=\"#series-pictorialBar.markPoint.data.type\">type</a> 时有效，用于指定在哪个维度上指定最大值最小值。这可以是维度的直接名称，例如折线图时可以是<code class=\"codespan\">x</code>、<code class=\"codespan\">angle</code>等、candlestick 图时可以是<code class=\"codespan\">open</code>、<code class=\"codespan\">close</code>等维度名称。</p>\n"
  },
  ...
  "markLine.symbol": {
    "desc": "<p>标线两端的标记类型，可以是一个数组分别指定两端，也可以是单个统一指定，具体格式见 <a href=\"#series-pictorialBar.markLine.data.0.symbol\">data.symbol</a>。</p>\n"
  },
  "markLine.symbolSize": {
  ...
  "markLine.data.0.valueIndex": {
    "desc": "\n\n<p>在使用 <a href=\"#series-pictorialBar.markLine.data.type\">type</a> 时有效，用于指定在哪个维度上指定最大值最小值，可以是 <code class=\"codespan\">0</code>（xAxis, radiusAxis），<code class=\"codespan\">1</code>（yAxis, angleAxis），默认使用第一个数值轴所在的维度。</p>\n",
    "uiControl": {
      "type": "number",
      "min": "0",
      "max": "1",
  ...
  "markLine.data.0.valueDim": {
    "desc": "<p>在使用 <a href=\"#series-pictorialBar.markLine.data.type\">type</a> 时有效，用于指定在哪个维度上指定最大值最小值。这可以是维度的直接名称，例如折线图时可以是<code class=\"codespan\">x</code>、<code class=\"codespan\">angle</code>等、candlestick 图时可以是<code class=\"codespan\">open</code>、<code class=\"codespan\">close</code>等维度名称。</p>\n"
  },
  ...
  "markArea.data.0.valueIndex": {
    "desc": "\n\n<p>在使用 <a href=\"#series-pictorialBar.markArea.data.type\">type</a> 时有效，用于指定在哪个维度上指定最大值最小值，可以是 <code class=\"codespan\">0</code>（xAxis, radiusAxis），<code class=\"codespan\">1</code>（yAxis, angleAxis），默认使用第一个数值轴所在的维度。</p>\n",
    "uiControl": {
      "type": "number",
      "min": "0",
      "max": "1",
  ...
  "markArea.data.0.valueDim": {
    "desc": "<p>在使用 <a href=\"#series-pictorialBar.markArea.data.type\">type</a> 时有效，用于指定在哪个维度上指定最大值最小值。这可以是维度的直接名称，例如折线图时可以是<code class=\"codespan\">x</code>、<code class=\"codespan\">angle</code>等、candlestick 图时可以是<code class=\"codespan\">open</code>、<code class=\"codespan\">close</code>等维度名称。</p>\n"
  },
  ...
  "z": {
    "desc": "<p>象形柱图组件的所有图形的<code class=\"codespan\">z</code>值。控制图形的前后顺序。<code class=\"codespan\">z</code>值小的图形会被<code class=\"codespan\">z</code>值大的图形覆盖。</p>\n<p><code class=\"codespan\">z</code>相比<code class=\"codespan\">zlevel</code>优先级更低，而且不会创建新的 Canvas。</p>\n"
  },
  "silent": {
    "desc": "\n\n<p>图形是否不响应和触发鼠标事件，默认为 false，即响应和触发鼠标事件。</p>\n",
    "uiControl": {
