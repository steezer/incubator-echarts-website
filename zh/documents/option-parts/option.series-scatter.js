window.__EC_DOC_option_series_scatter = {
  ...
  "markPoint.data.valueIndex": {
    "desc": "\n\n<p>在使用 <a href=\"#series-scatter.markPoint.data.type\">type</a> 时有效，用于指定在哪个维度上指定最大值最小值，可以是 <code class=\"codespan\">0</code>（xAxis, radiusAxis），<code class=\"codespan\">1</code>（yAxis, angleAxis），默认使用第一个数值轴所在的维度。</p>\n",
    "uiControl": {
      "type": "number",
      "min": "0",
      "max": "1",
  ...
  "markPoint.data.valueDim": {
    "desc": "<p>在使用 <a href=\"#series-scatter.markPoint.data.type\">type</a> 时有效，用于指定在哪个维度上指定最大值最小值。这可以是维度的直接名称，例如折线图时可以是<code class=\"codespan\">x</code>、<code class=\"codespan\">angle</code>等、candlestick 图时可以是<code class=\"codespan\">open</code>、<code class=\"codespan\">close</code>等维度名称。</p>\n"
  },
  ...
  "markLine.symbol": {
    "desc": "<p>标线两端的标记类型，可以是一个数组分别指定两端，也可以是单个统一指定，具体格式见 <a href=\"#series-scatter.markLine.data.0.symbol\">data.symbol</a>。</p>\n"
  },
  "markLine.symbolSize": {
  ...
  "markLine.data.0.valueIndex": {
    "desc": "\n\n<p>在使用 <a href=\"#series-scatter.markLine.data.type\">type</a> 时有效，用于指定在哪个维度上指定最大值最小值，可以是 <code class=\"codespan\">0</code>（xAxis, radiusAxis），<code class=\"codespan\">1</code>（yAxis, angleAxis），默认使用第一个数值轴所在的维度。</p>\n",
    "uiControl": {
      "type": "number",
      "min": "0",
      "max": "1",
  ...
  "markLine.data.0.valueDim": {
    "desc": "<p>在使用 <a href=\"#series-scatter.markLine.data.type\">type</a> 时有效，用于指定在哪个维度上指定最大值最小值。这可以是维度的直接名称，例如折线图时可以是<code class=\"codespan\">x</code>、<code class=\"codespan\">angle</code>等、candlestick 图时可以是<code class=\"codespan\">open</code>、<code class=\"codespan\">close</code>等维度名称。</p>\n"
  },
  ...
  "markArea.data.0.valueIndex": {
    "desc": "\n\n<p>在使用 <a href=\"#series-scatter.markArea.data.type\">type</a> 时有效，用于指定在哪个维度上指定最大值最小值，可以是 <code class=\"codespan\">0</code>（xAxis, radiusAxis），<code class=\"codespan\">1</code>（yAxis, angleAxis），默认使用第一个数值轴所在的维度。</p>\n",
    "uiControl": {
      "type": "number",
      "min": "0",
      "max": "1",
  ...
  "markArea.data.0.valueDim": {
    "desc": "<p>在使用 <a href=\"#series-scatter.markArea.data.type\">type</a> 时有效，用于指定在哪个维度上指定最大值最小值。这可以是维度的直接名称，例如折线图时可以是<code class=\"codespan\">x</code>、<code class=\"codespan\">angle</code>等、candlestick 图时可以是<code class=\"codespan\">open</code>、<code class=\"codespan\">close</code>等维度名称。</p>\n"
  },
  ...
  "zlevel": {
    "desc": "<p>散点图所有图形的 zlevel 值。</p>\n<p><code class=\"codespan\">zlevel</code>用于 Canvas 分层，不同<code class=\"codespan\">zlevel</code>值的图形会放置在不同的 Canvas 中，Canvas 分层是一种常见的优化手段。我们可以把一些图形变化频繁（例如有动画）的组件设置成一个单独的<code class=\"codespan\">zlevel</code>。需要注意的是过多的 Canvas 会引起内存开销的增大，在手机端上需要谨慎使用以防崩溃。</p>\n<p><code class=\"codespan\">zlevel</code> 大的 Canvas 会放在 <code class=\"codespan\">zlevel</code> 小的 Canvas 的上面。</p>\n"
  },
  "z": {
    "desc": "<p>散点图组件的所有图形的<code class=\"codespan\">z</code>值。控制图形的前后顺序。<code class=\"codespan\">z</code>值小的图形会被<code class=\"codespan\">z</code>值大的图形覆盖。</p>\n<p><code class=\"codespan\">z</code>相比<code class=\"codespan\">zlevel</code>优先级更低，而且不会创建新的 Canvas。</p>\n"
  },
  "silent": {
    "desc": "\n\n<p>图形是否不响应和触发鼠标事件，默认为 false，即响应和触发鼠标事件。</p>\n",
    "uiControl": {
